    ...
    <footer className="bg-white pt-12 pb-8 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="border-t border-gray-300 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-gray-600 hover:text-gray-900 text-sm link-3d relative inline-block transition-colors duration-300">Privacy Policy</a>
            <a href="#" className="text-gray-600 hover:text-gray-900 text-sm link-3d relative inline-block transition-colors duration-300">Terms of Service</a>
            <a href="#" className="text-gray-600 hover:text-gray-900 text-sm link-3d relative inline-block transition-colors duration-300">Cookie Policy</a>
          </div>
        </div>
      </div>
