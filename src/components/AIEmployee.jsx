...
const AIEmployee = () => {
  ...
  return (
    <section className="py-20 bg-white border-y border-gray-300 text-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          {/* Left Content */}
          <div className="mb-12 lg:mb-0">
            ...
            {/* Testimonial */}
            <div className="bg-gray-100 border-l-4 border-blue-500 rounded-r-lg p-6 mb-8">
              <div className="flex items-start">
                <div className="flex-shrink-0">
                  <FontAwesomeIcon icon={faQuoteLeft} className="text-blue-400 text-xl mt-1 mr-3" />
                </div>
                <div>
                  <p className="italic mb-2 text-black">
                    "This thing is unreal. Takes calls, generates leads & bookings, sends recap emails & transcripts - it can even shoot follow up texts to the caller!"
                  </p>
          ...
          <div>
            <div className="bg-gray-100 rounded-xl border border-gray-300 p-6">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-sm text-black">AI Call • In Progress</div>
              </div>
              ...
              <div className="bg-gray-200 rounded-lg p-4 mb-4">
                <div className="flex items-center mb-3">
                  ...
                  <div>
                    <h4 className="font-bold text-black">AI Assistant</h4>
                    <div className="text-xs text-black">Responding to customer</div>
                  </div>
                </div>
                <div className="pl-13">
                  {aiMessages.map((message, index) => (
              ...
              <div className="bg-gray-200 rounded-lg p-4">
                <div className="flex items-center mb-3">
                  ...
                  <div>
                    <h4 className="font-bold text-black">Customer</h4>
                    <div className="text-xs text-black">Sarah M.</div>
                  </div>
                </div>
                <div className="pl-13">
                  {customerMessages.map((message, index) => (
                    <div key={index} className="bg-gray-300 rounded-tl-lg rounded-tr-lg rounded-bl-lg p-3 mb-2 last:mb-0">
                      <p className="text-sm text-black">{message}</p>
                    </div>
                  ))}
                </div>
              ...
              <div className="mt-4 flex items-center">
                ...
                <div className="flex-grow bg-gray-300 rounded-full py-2 px-4 text-sm text-black">
                  AI is responding...
                </div>
                <div className="ml-3 flex items-center justify-center w-10 h-10 bg-blue-600 rounded-full hover:bg-blue-700 transition-colors cursor-pointer">
                  <FontAwesomeIcon icon={faPaperPlane} className="text-white" />
