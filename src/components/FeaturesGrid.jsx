      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            const IconComponent = feature.icon;
            return (
              <div key={index} className="bg-gray-100 p-6 rounded-xl border border-gray-300 hover:border-gray-400 transition-colors">
                <div className={`w-12 h-12 ${getColorClasses(feature.color)} rounded-lg flex items-center justify-center mb-4`}>
                  <IconComponent className="w-5 h-5" />
                </div>
          ...
          {/* CTA Card */}
          <div className="bg-gray-100 p-6 rounded-xl border border-gray-300 bg-gradient-to-br from-gray-100 to-blue-100 relative overflow-hidden hover:border-gray-400 transition-colors">
            <div className="absolute -top-10 -right-10 w-32 h-32 bg-blue-600/10 rounded-full filter blur-xl"></div>
            <div className="relative z-10">
              <h3 className="text-xl font-bold mb-3 text-black">Ready to automate your business?</h3>
              <p className="text-black mb-6">
                WANT TO SEE A DEMO OF AI VOICE AGENT?
              </p>
              <button className="inline-flex items-center px-6 py-3 bg-black text-white">
                Try It Yourself For Free!
              </button>
