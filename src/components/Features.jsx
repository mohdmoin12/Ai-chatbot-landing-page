...
const FeatureCard = ({ icon, title, description, details }) => {
  ...
  return (
    <div 
      ref={ref}
      className={`feature-card bg-white border-2 border-gray-200 rounded-xl p-6 transition duration-300 transform hover:shadow-lg ${inView ? 'animate__animated animate__fadeInUp' : 'opacity-0'}`}
    >
      ...
      <div className="inline-block px-3 py-1 bg-gray-100 text-black rounded-full text-sm font-medium">
        Learn more →
      </div>
      <div className="mt-4 pt-4 border-t border-gray-200 flex items-center text-sm text-gray-600">
        <FontAwesomeIcon icon={details.icon} className="mr-2 text-black" />
        {details.text}
      </div>
    </div>
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-black">
            <span className="text-black">Powerful Features</span> To Transform Your Business
          </h2>
        ...
        <div className="mt-16 text-center">
          <a 
            href="#contact" 
            className="inline-flex items-center px-8 py-4 bg-black hover:bg-gray-800 rounded-xl font-bold text-white hover:shadow-xl transition-all transform hover:scale-105"
          >
            <span>Try Our All-In-One Software For Free</span>
            <FontAwesomeIcon icon={faArrowRight} className="ml-2" />
          </a>
