...
const Communication = () => {
  const channels = [
    { icon: faPhoneAlt, name: "Phone Calls" },
    { icon: faSms, name: "SMS" },
    { icon: faEnvelope, name: "Email" },
    { icon: faWhatsapp, name: "WhatsApp" },
    { icon: faFacebookMessenger, name: "Facebook Messages" },
    { icon: faInstagram, name: "Instagram Messages" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {channels.map((channel, index) => (
                <div key={index} className="flex items-center bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <div className="w-12 h-12 rounded-lg bg-gray-100 text-black flex items-center justify-center mr-4">
                    <FontAwesomeIcon icon={channel.icon} className="text-xl" />
                  </div>
            ...
            <div className="bg-gray-50 p-5 rounded-xl border-l-4 border-black">
              <div className="flex items-start">
                <div className="flex-shrink-0">
                  <FontAwesomeIcon icon={faHeadset} className="text-2xl mr-3 text-black" />
                </div>
                <div>
                  <h4 className="text-lg font-bold mb-2 text-black">24/7 Customer Service Response</h4>
          ...
          <div className="mt-12 lg:mt-0">
            <div className="relative bg-gray-50 border border-gray-200 rounded-2xl overflow-hidden h-96">
              <div className="absolute inset-0 bg-gradient-to-b from-gray-100 to-gray-50"></div>
              
              {/* Browser Header */}
              <div className="absolute top-5 left-5 right-5 bg-white rounded-lg p-3 border border-gray-200">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-red-500 rounded-full mr-2"></div>
                  <div className="w-2 h-2 bg-yellow-500 rounded-full mr-2"></div>
                  <div className="w-2 h-2 bg-green-500 rounded-full mr-2"></div>
                  <div className="ml-2 text-xs text-gray-600">dashboard.ai</div>
                </div>
              </div>
              
              {/* Chat Interface */}
              <div className="absolute top-20 left-5 right-5 bottom-5 bg-white/90 rounded-lg backdrop-blur-sm p-4 border border-gray-200">
                {/* AI Message */}
                <div className="flex items-center mb-4">
                  ...
                  <div className="flex-grow">
                    <div className="h-3 bg-gray-200 rounded-full animate-pulse mb-2" style={{width: '70%'}}></div>
                    <div className="h-2 bg-gray-200 rounded-full animate-pulse" style={{width: '50%'}}></div>
                  </div>
                </div>
                
                {/* Message Content */}
                <div className="space-y-3 mb-4">
                  <div className="h-3 bg-gray-200 rounded-full animate-pulse" style={{width: '90%'}}></div>
                  <div className="h-3 bg-gray-200 rounded-full animate-pulse" style={{width: '80%'}}></div>
                  <div className="h-3 bg-gray-200 rounded-full animate-pulse" style={{width: '60%'}}></div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-grow">
                    <div className="h-3 bg-gray-200 rounded-full animate-pulse mb-2" style={{width: '60%'}}></div>
                    <div className="h-2 bg-gray-200 rounded-full animate-pulse" style={{width: '40%'}}></div>
                  </div>
                </div>
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="flex items-center bg-gray-100 rounded-full p-2">
                    <div className="w-6 h-6 bg-gray-200 rounded-full ml-1 mr-3"></div>
                    <div className="text-xs text-gray-500">Type a message...</div>
                    <div className="ml-auto w-6 h-6 bg-gray-200 rounded-full flex items-center justify-center">
              ...
              {/* Animated Background Element */}
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gray-200 rounded-full opacity-20 animate-pulse"></div>
            </div>
            
            {/* Workflow Section */}
            <div className="mt-8 p-6 bg-gray-50 rounded-xl border border-gray-200">
              <h4 className="text-lg font-bold mb-4 text-black">Automate Tasks Using Workflows</h4>
              <p className="text-gray-600 text-sm mb-4">
                We can trigger actions like send calendar, book appointments, call customers or leads all without you having to lift a finger.
              </p>
              <div className="flex -space-x-2">
                {actions.map((action, index) => (
                  <div key={index} className="w-8 h-8 rounded-full border-2 border-black bg-gray-100 flex items-center justify-center">
                    <FontAwesomeIcon icon={action.icon} className="text-xs text-black" />
                  </div>
                ))}
              </div>
            </div>
